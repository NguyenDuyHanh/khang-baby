    ...
    <div className="space-y-6 lg:space-y-8 animate-in fade-in duration-500">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm lg:text-base text-muted-foreground mt-1">Xin chào, Quản lý KhangBaby Chũ!</p>
        </div>
      ...
      <div className="grid gap-6 grid-cols-1 lg:grid-cols-7">
        <Card className="lg:col-span-4 border-none shadow-sm">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <button className="text-xs lg:text-sm font-medium text-primary hover:underline">Xem tất cả</button>
          </CardHeader>
          <CardContent>
        ...
        <Card className="lg:col-span-3 border-none shadow-sm bg-primary text-white overflow-hidden relative min-h-[200px]">
          <CardHeader>
